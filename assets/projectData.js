export const projectData = [
  ...
  },
  {
    ...
    readme: {
      ...
      meaning:
        'Next.js로 다시 개발하는 과정에서 서버 사이드 렌더링을 함께 지원하는 Next.js의 편리함과 실용성을 느낄 수 있었습니다. slider관련 library는 기존에도 많이 사용해 보았기 때문에 사용하는데에 번거롭거나 어려운 점이 없었습니다. 하지만 스크롤 관련 custom hook은 처음 구현해 보았는데 익숙하지 않은 방식이라 조금 어려움이 있었습니다. object에 미리 정의해둔 메뉴들을 useRef를 사용하여 element의 위치를 찾아 스크롤을 이동시켜주는 형태로 사용하였습니다. 또한, Vercel을 이용하여 정적 웹사이트의 Lean한 배포도 경험해볼 수 있었습니다.',
      techStack: {
        frontend: 'Next.js, Typescript, React, css module, React-Slick',
        backend: '',
        database: '',
